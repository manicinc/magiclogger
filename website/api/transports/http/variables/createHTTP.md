...
> `const` **createHTTP**: (`endpoint`, `options?`) => [`HTTPTransport`](../../HTTPTransport/classes/HTTPTransport.md) = `createHTTPTransport`

Defined in: [src/transports/http.ts:68](https://github.com/manicinc/magiclogger/blob/ed8c08fedff86817c85e526f7d2db758b6e30dfa/src/transports/http.ts#L68)
