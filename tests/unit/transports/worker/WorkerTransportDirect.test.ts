...
describe('WorkerTransport Direct Coverage', () => {
  ...
  describe('WorkerTransport Class', () => {
    ...
    it('should handle large entries', async () => {
      ...
      expect(warnSpy).toHaveBeenCalledWith('[WorkerTransport] Entry too large, dropping');
    ...
    it('should handle worker exit', async () => {
      ...
      expect(errorSpy).toHaveBeenCalledWith('[WorkerTransport] Worker exited with code 1');
    ...
    it('should use custom worker path', async () => {
      ...
      expect(Worker).toHaveBeenCalledWith('/custom/path/worker.js', expect.any(Object));
    });
