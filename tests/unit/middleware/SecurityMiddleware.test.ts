...
describe('SecurityMiddleware', () => {
  ...
  describe('Log Injection Prevention', () => {
    it('should detect fake timestamp injection', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('[SecurityMiddleware] Potential injection attempt detected');
  ...
  describe('Context Sanitization', () => {
    it('should limit context depth', () => {
      ...
      expect((result.entry?.context?.level1 as any).level2).toEqual({ _error: 'Max depth exceeded' });
    });
